...
Blockly.Blocks['led_rgb_config'] = {
  init: function () {
    ...
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("/media/LED RGB.PNG", 150, 100, { alt: "*", flipRtl: "FALSE" }));
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("RED PIN")
      .appendField(new Blockly.FieldDropdown([
...
//----------------------------------tact sw--------------------------------------------
Blockly.Blocks['tact_sw_init'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Tact Switch init");
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("/media/tact-sw.PNG", 150, 150));
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Pin : ")
      .appendField(new Blockly.FieldDropdown([
...
//value
Blockly.Blocks['tact_sw_val'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Value of Tact Switch");
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("/media/tact-sw.PNG", 150, 150, { alt: "*", flipRtl: "FALSE" }));
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Pin : ")
      .appendField(new Blockly.FieldDropdown([
